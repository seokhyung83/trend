...
def show_spec(tmp_abs, tmp_article):
    ...
    return list(zip([info_join['4_y'][i] for i, v in enumerate(final_sent) if len(v)>=1], [v for i, v in enumerate(final_sent) if len(v)>=1]))
